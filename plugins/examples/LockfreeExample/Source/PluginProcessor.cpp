...
//==============================================================================
void NewProjectAudioProcessor::prepareToPlay (double sr, int samplesPerBlock)
{
    // Use this method as the place to do any pre-playback
    // initialisation that you need..
    const auto samplesPerCycle = sr / 120.f;
    step = juce::MathConstants<float>::twoPi / samplesPerCycle;
    vizQueue.resize(sr / 60);
}
...
void NewProjectAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    const auto max = std::max(std::abs(minMax.getStart()), std::abs(minMax.getEnd()));
